...
function ResizableTable(selector) {
    ...
    this.prepareEventListener = function(resizableTable) {
        ...
        let ths = resizableTable.querySelectorAll('thead > tr > th');
    ...
    this.mouseDown = function(e, th) {
        ...
        th.closest('table').querySelectorAll(`tbody tr`).forEach(row => {
            row.cells[colIndex]?.classList.add('resizing');
        });
    ...
    this.onMouseUp = function(th, colIndex) {
        ...
        document.querySelectorAll(`tbody > tr`).forEach(row => {
            row.cells[colIndex]?.classList.remove('resizing');
        });
...
// Initialize the resizable table functionality when the DOM is fully loaded
document.addEventListener('DOMContentLoaded', function() {
    ResizableTable('.resizable-table'); // Apply to tables with the class 'resizable-table'
});